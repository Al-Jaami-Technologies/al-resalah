...
const SmsBuy = () => {
  ...
  <div>
    <center>
      <h1 className="hind-siliguri-bold deep-green mt-[60px] sm:mt-[80px] lg:mt-[110px] mb-3 text-[28px] sm:text-[36px] lg:text-[40px] leading-snug">
        যেকোনো <span class="light-green">পরিমাণ রিচার্জ</span> করুন,<br />
        শুধু ব্যবহার অনুযায়ী <span class="light-green">খরচ করুন!</span>
      </h1>
    </center>

    <center>
      <h1 className="hind-siliguri-semibold light-green mt-[27px] text-[20px] sm:text-[22px] md:text-[24px]">
  ...
  <section className="mt-[27px] px-4">
    ...
    <center>
      <div className="mt-[20px] w-full px-4">
        <input type="amount" placeholder="আপনার এসএমএস এর পরিমাণ এখানে লিখুন" className="p-4 rounded-[8px] border-[2px] w-full max-w-[373px] h-[48px] in_put" />
      </div>
    </center>

    <center>
      <h1 className="deep-green hind-mysuru-bold text-[28px] sm:text-[32px] md:text-[36px] mt-[20px]">৯,৬০০ টাকা মাত্র</h1>
      <p className="deep-green hind-mysuru-bold text-[16px] sm:text-[18px] mt-[20px]">
        প্রতিটি <span className="light-green">মাস্কিং</span> এসএমএস এর মুল্য <span className="light-green">০.৪৮</span> পয়সা মাত্র
      </p>
    </center>

    <center>
      <button className="my-3 w-full max-w-[576px] h-[56px] sm:h-[64px] text-white rounded-[8px] mid_button hind-siliguri-bold text-[20px] sm:text-[24px] mt-[20px] mb-[49px] cursor-pointer">
