...
const Banner = () => {
  ...
  <div className="flex flex-col-reverse lg:flex-row max-w-[1200px] mx-auto items-center">
    ...
    <div className="w-full lg:w-2/3 flex-1 font-hind-siliguri mt-6 lg:mt-0">
      <h1 className="font-bold text-[2.25rem] sm:text-[3rem] lg:text-[4.375rem] deep-green leading-tight">
      ...
      <ul className="hind-siliguri-regular text-[1rem] sm:text-[1.125rem] my-4 lg:mt-[27px] deep-green space-y-2">
        <li className="flex items-start space-x-2">
          <img src="/images/heroPage/right.svg" alt="" className="w-[20px] h-[20px] mt-1" />
          <span>কোনো প্রকার লুকানো ফি নেই, শুধু ব্যবহার অনুযায়ী পেমেন্ট!</span>
        </li>
        <li className="flex items-start space-x-2">
          <img src="/images/heroPage/right.svg" alt="" className="w-[20px] h-[20px] mt-1" />
      ...
      <button className="box-border rounded-lg bg-[rgb(9,104,67)] px-8 sm:px-[6rem] lg:px-[9.017rem] py-[1rem] lg:py-[1.25rem] cursor-pointer mt-4">
