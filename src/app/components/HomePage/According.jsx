      ...
      <div className="w-full max-w-[1200px] flex flex-col gap-4">
        ...
        <div
          ...
          style={{
            ...
            borderBottom: "none",
            boxShadow:
              "10px 0 15px -10px rgba(0, 0, 0, 0.08), -10px 0 15px -10px rgba(0, 0, 0, 0.08)",
          }}
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-[18px] sm:text-[18px] mt-3 deep-green font-hind-siliguri font-semibold">
              "রাত ১২টায়ও<span className="yellow"> সমস্যা?</span>{" "}
              আমাদের বাংলা-ভাষী টিম কল, WhatsApp, বা লাইভ চ্যাটে সাহায্য করবে।
