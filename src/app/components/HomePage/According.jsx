...
const According = () => {
  ...
  <div className="w-full max-w-[1200px] flex flex-col gap-4">
    ...
    {[
      ...
      <div
        key={index}
        className="custom-card w-full rounded-[40px] border-[#81cb2d] border-t-[1px] px-6 py-4 bg-white flex items-center gap-4"
        style={{ height: '80px' }}
      >
        ...
        <p className="text-[24px] font-bold deep-green font-hind-siliguri">{text}</p>
      </div>
    ))}

    {/* Full Card 5 */}
    <div
      className="custom-card w-full rounded-[40px] border-t-[1px] border-[#81cb2d] p-6 bg-white flex flex-col lg:flex-row sm-items-center justify-between gap-6 shadow-left-right"
      style={{
        height: '329px',
        borderBottom: 'none',
    ...
    >
      {/* Number bubble */}
      <div className="w-[43px] h-[43px] border-2 border-[#81cb2d] rounded-full flex items-center justify-center text-green-800 text-[20px] font-bold shrink-0">
        <p>০৫</p>
      </div>
      ...
      <div className="flex-1 text-center lg:text-left">
        ...
        <p className="text-[18px] sm:text-[18px] mt-2 deep-green font-hind-siliguri font-semibold">
