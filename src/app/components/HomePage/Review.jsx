...
const Review = () => {
  return (
    <section className="max-w-[1200px] mx-auto px-4 py-10">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center sm:gap-0 gap-6">
        {/* Left Image */}
        <img
        ...
        <img
          ...
          alt="Review 2"
          className="w-full max-w-[300px] md:max-w-[300px] object-contain shadow-lg rounded-[10px]"
        />
